  ...
  return (
    <footer className='w-screen bg-violet-300 py-4 text-black'>
      <div className='container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row'>
        <p className='text-center hover:underline text-sm md:text-left md:flex-1'>
          &copy; Inspired By Cyberpunk Edgerunners - Aaditya Chhatraliya
        </p>
        ...
        <p className='text-center text-sm hover:underline md:text-right md:flex-1'>
          The Night City
        </p>
      </div>
    </footer>
